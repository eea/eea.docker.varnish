pipeline {
  ...
  environment {
    ...
    DEPENDENT_DOCKERFILE_URL="eea/plone-varnish/blob/master/Dockerfile eea/plone-varnish/blob/master/plone5/Dockerfile eea/eea.docker.varnish-reportek/blob/master/Dockerfile"
  }
